...
const branch = `
  <g fill="none" stroke="#eef6f4" stroke-width="14" stroke-linecap="round">
    <path d="M160 380 C 220 300, 280 240, 360 170"/>
  </g>
  <g fill="#93dcd2" stroke="#eef6f4" stroke-width="6">
  ...
  <circle cx="305" cy="300" r="26" fill="#a9745b" stroke="#eef6f4" stroke-width="6"/>
  <circle cx="345" cy="255" r="26" fill="#1f7269" stroke="#eef6f4" stroke-width="6"/>`;

// "any": quadrato arrotondato, angoli trasparenti
const anySvg = `<svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512"><rect width="512" height="512" rx="96" fill="#2f9389"/>${branch}</svg>`;

// "maskable": sfondo a tutto campo, contenuto nella safe-zone (80%)
const maskSvg = `<svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512"><rect width="512" height="512" fill="#2f9389"/><g transform="translate(51.2,51.2) scale(0.8)">${branch}</g></svg>`;
